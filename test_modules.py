...
def find_log():
    log = open('/home/polina/PycharmProjects/moxa_monitoring/moxa.log', 'r')
    log = log.readlines()
    return log
...
def delete_lines():
    ...
    for index in sorted(del_list, reverse=True):
        del log[index]
    with open('/home/polina/PycharmProjects/moxa_monitoring/moxa.log', 'w+') as new:
        for item in log:
            new.write(item)
...
def load_file(name, num):
    import pickle
    _file = open('/home/polina/PycharmProjects/moxa_monitoring/parameters/%s%s.pkl' % (name, num), "rb")
...
def dump_file(name, num, dict_new):
    import pickle
    _file = open("/home/polina/PycharmProjects/moxa_monitoring/parameters/%s%s.pkl" % (name, num), "wb")
    pickle.dump(dict_new, _file)
    _file.close()

def play_sound():
    os.system('mpg123 /home/polina/PycharmProjects/moxa_monitoring/sound.mp3')
