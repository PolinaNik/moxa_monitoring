...
common_values1 = [i for i in moxa1.values() if i in moxa3.values()]
common_values2 = [i for i in moxa2.values() if i in moxa4.values()]

unique_values1 = [i for i in moxa1.values() if i not in common_values1]
unique_values2 = [i for i in moxa2.values() if i not in common_values2]
unique_values3 = [i for i in moxa3.values() if i not in common_values1]
unique_values4 = [i for i in moxa4.values() if i not in common_values2]
